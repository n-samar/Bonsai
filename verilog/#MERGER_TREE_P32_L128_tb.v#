...
module merger_tree_tb;
   ...
   wire [1024-1:0] o_data;
   reg 	       clk;
   wire [1024-1:0] out_fifo_item;
   ...
   IFIFO16 #(1024) fifo_out(.i_clk(clk),
		 .i_data(o_data),
   ...
   MERGER_TREE_P32_L128 dut (.i_clk(clk),
   ...
   always @(posedge clk) begin
	 ...
	 if(read_fifo_out) begin
      ...
      else if(counter == LEAF_CNT*LEN_SEQ/2+2000) begin
	 $fclose(f);
	 $finish;
      end
   end
