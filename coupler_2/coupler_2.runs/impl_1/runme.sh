...
HD_PWD='/curr/dzonilakoni/research_helpers/coupler_2/coupler_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log COUPLER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source COUPLER.tcl -notrace
