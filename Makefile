...
test_tree_P8_L32_32b : src/FIFO.v src/MERGER.v src/MERGER_4.v src/MERGER_2.v src/CONTROL.v src/BITONIC_NETWORK.v src/BITONIC_NETWORK_4.v src/BITONIC_NETWORK_8.v src/MERGER_TREE_P8_L32_32b.v test/MERGER_TREE_P8_L32_32b_tb.v src/COUPLER.v test/datagen.py
	...
	$(VERILOG) -o tree_P8_L32_32b src/COUPLER.v src/FIFO.v src/MERGER.v src/MERGER_4.v src/MERGER_2.v src/CONTROL.v src/BITONIC_NETWORK.v src/BITONIC_NETWORK_4.v src/BITONIC_NETWORK_8.v src/MERGER_TREE_P8_L32_32b.v test/MERGER_TREE_P8_L32_32b_tb.v;
	$(VVP) tree_P8_L32_32b;
